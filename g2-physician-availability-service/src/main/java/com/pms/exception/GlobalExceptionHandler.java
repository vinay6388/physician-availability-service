...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(PhysicianServiceException.class)
	public ResponseEntity<?> physicianServiceNotFoundExceptions(PhysicianServiceException ex, WebRequest request) {
		ErrorResponse errorDetails = new ErrorResponse(HttpStatus.NOT_FOUND, LocalDateTime.now(), ex.getMessage(),
				request.getDescription(false));
	...
	@ExceptionHandler
	public ResponseEntity<ErrorResponse> physicianServiceBadRequestExceptions(Exception ex, WebRequest request) {
